...
def main():
    ...
    model.vgg16.load_weights('/Users/rossgoldbaum/Desktop/CS1430_Projects/cv-final/vgg16_imagenet.weights.h5')
    model.head.load_weights('/Users/rossgoldbaum/Desktop/CS1430_Projects/cv-final/vgg.e018-acc0.9679.weights.h5')
    ...
    image = '/Users/rossgoldbaum/Desktop/CS1430_Projects/cv-final/image.png'
    print(classify(image, model))
